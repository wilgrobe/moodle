...
/**
 * The mod_scorm sco passed event.
 *
 * @package    mod_scorm
 * @author     Will Groberg
...
/**
 * The mod_scorm sco passed event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */
class sco_passed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' passed the sco with id '$this->objectid' for the scorm with " .
    ...
    public static function get_name() {
        return get_string('eventscopassed', 'mod_scorm');
    }
