...
/**
 * The mod_scorm sco failed event.
 *
 * @package    mod_scorm
 * @author     Will Groberg
...
/**
 * The mod_scorm sco failed event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */
class sco_failed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' failed the sco with id '$this->objectid' for the scorm with " .
    ...
    public static function get_name() {
        return get_string('eventscofailed', 'mod_scorm');
    }
